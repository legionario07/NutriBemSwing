 ...
 * @author PauLinHo
 */
public class FrmCategoria extends javax.swing.JDialog implements IForm{
    ...
    public FrmCategoria(java.awt.Frame parent, boolean modal) {
        ...
        categorias = GuiUtil.inicializarDadosNasTabelas(new br.com.nutribem.dominio.Categoria());
        preencherTabelas();
    ...
    public void inicializarCampoPesquisa() {
        txtLocaliza.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void insertUpdate(DocumentEvent e) {
                TableUtil.filterTable((TableRowSorter<CategoriaTableModel>) tabelaCategorias.getRowSorter(), txtLocaliza.getText());
            }
    ...
    public void preencherTabelas() {
        ...
        tabelaCategorias = GuiUtil.configurarTabelas(tabelaCategorias);
        tabelaCategorias.setModel(categoriaTableModel);
        TableRowSorter<CategoriaTableModel> sorter = new TableRowSorter<CategoriaTableModel>(categoriaTableModel);
        tabelaCategorias.setRowSorter(sorter);
    ...
    private void initComponents() {
        ...
        pnScrollCategoria.setViewportView(tabelaCategorias);
    ...
    public Resultado salvar() {
        ...
        categoria.setCategoria(txtCategoria.getText().toUpperCase());

        return fachada.save(categoria);
    ...
    public Resultado editar() {
        ...
        categoria.setCategoria(txtCategoria.getText().toUpperCase());
        categoria.setId(Long.valueOf(txtId.getText().toUpperCase()));

        return fachada.update(categoria);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (resultado.getEntidades().isEmpty()) {
            ...
            categorias = GuiUtil.inicializarDadosNasTabelas(new Categoria());
            preencherTabelas();
    ...
    private void tabelaCategoriasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaCategoriasMouseClicked
        // TODO add your handling code here:
        txtId.setText(String.valueOf(tabelaCategorias.getValueAt(tabelaCategorias.getSelectedRow(), 0)));
        txtCategoria.setText(String.valueOf(tabelaCategorias.getValueAt(tabelaCategorias.getSelectedRow(), 1)));
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        categoria = new Categoria();
        categoria.setId(Long.valueOf(txtId.getText()));

        resultado = new Resultado();
        resultado = fachada.delete(categoria);
