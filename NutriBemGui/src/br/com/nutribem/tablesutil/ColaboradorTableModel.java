 ...
 * @author PauLinHo
 */
public class ColaboradorTableModel extends TabelaModelo {
     ...
     * @param lista
     */
    public ColaboradorTableModel(List<EntidadeDominio> lista) {
    ...
    public Object getValueAt(int linha, int coluna) {
        ...
        Colaborador objeto = (Colaborador) lista.get(linha);
        switch (coluna) {
            case 0:
                return objeto.getId();
            case 1:
            ...
            case 2:
                return objeto.getDataDeNascimento();
            case 3:
                return objeto.getCpf();
            case 4:
                return objeto.getContato().getCelular();
            case 5:
                return objeto.getContato().getTelefoneFixo();
